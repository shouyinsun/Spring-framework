...
public class ContextLoader {
	...
	static {//加载属性文件中设置的默认策略 (默认的,不能外部定制)
	...
	public WebApplicationContext initWebApplicationContext(ServletContext servletContext) {
		...
		try {
			...
			//存储到实例变量里面,确保在ServletContext关闭时可用
			...
			//webApplicationContext 存放在servletContext的 ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE 属性中
