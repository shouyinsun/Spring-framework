...
public class RmiProxyFactoryBean extends RmiClientInterceptor implements FactoryBean<Object>, BeanClassLoaderAware {
	...
	public void afterPropertiesSet() {
		...
		//Interceptor extend Advice

		/**
		 * 代理类使用当前bean作为增强器进行增强,方法调用时会调用 RmiProxyFactoryBean
		 * 父类 RmiClientInterceptor 的 invoke方法
		 */
	...
	@Override
	public Object getObject() {//FactoryBean 调用getObject犯法
