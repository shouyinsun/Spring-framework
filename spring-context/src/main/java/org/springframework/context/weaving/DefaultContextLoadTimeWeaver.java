...
public class DefaultContextLoadTimeWeaver implements LoadTimeWeaver, BeanClassLoaderAware, DisposableBean {
	...
	public void setBeanClassLoader(ClassLoader classLoader) {
		...
		//检查当前虚拟机中的Instrumentation实例是否可用
			...
			//在LoadTimeWeaverBeanDefinitionParser 中
			// AspectJWeavingEnabler 类型的bean 的loadTimeWeaver属性初始化为 DefaultContextLoadTimeWeaver 类型的bean
			// DefaultContextLoadTimeWeaver 中将 loadTimeWeaver 属性初始化为 InstrumentationLoadTimeWeaver 类型的bean
